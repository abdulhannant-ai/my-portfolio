...
const certData = [
    ...
    },
  {
    ...
    description: "Achieved Runner-Up position in the Logic Design Competition at ZAB-e-Fest’25, SZABIST University. Grateful to Prof. Dr. Sajjad Hussain Rizvi, Prof. Dr. Imran Amin, and Prof. Dr. Faraz Junejo for their guidance.",
  ...
  },
  {
    ...
    description: "Won first place in the Web Development Project competition at SPEC 2024, Karachi Institute of Economics and Technology, showcasing innovative web solutions. Thankful to the Pakistan Air Force and organizers Syed Najeeeb Haider Jafri, Engr. Fayyaz Khan, and Engr. Kainat Siddiqui.",
    icon: <Award className="w-6 h-6 text-white" />,
    color: "bg-teal-700",
  },
  {
    year: "2024",
    title: "Certificate of Participation, Speed Coding",
    description: "Participated in the Speed Coding event at SPEC 2024, Karachi Institute of Economics and Technology, organized by the Pakistan Air Force and supported by Syed Najeeeb Haider Jafri, Engr. Fayyaz Khan, and Engr. Kainat Siddiqui.",
    icon: <Award className="w-6 h-6 text-white" />,
    color: "bg-teal-700",
  },
];
